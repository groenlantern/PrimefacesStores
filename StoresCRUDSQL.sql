...
CALL getStellrDistributionPartners(@google);
select @google;
...
CALL getStellrDistributionPartnerNames(@google);
select @google;
...
CALL getStellrStoreType(@google);
select @google;
...
call deleteStellrStores(1184, 1189, @outt);
select @outt;
...
call getAddressDataAsString(13727,@ut);
...
call getStoreAddressDataAsString(13727,@ut); 
select @ut;

call doStoresAuditTrail(  10, 10 , 'test', 'usertest',  'create', 
'', 'Store [10:IN.VIJAY0001:11:5:1732:VSOPERAHOUSEMUMBAI:null:9819285653:2015-03-18 12:59:16:2015-08-01 13:01:30:1::NULL:] Address [11:Mama Parmanand Road, Near Roxy Cinema, Opera HousCharni Road,Chari Road West:Maharashtra:MUMBAI:400004:India]', 
@outt );
